...
import { Package, ShoppingCart, BarChart3, Settings, LogOut, ClipboardList, Users, ShoppingBag, ClipboardCheck, Truck, TrendingUp, Wallet } from 'lucide-react'
...
export default function DashboardLayout() {
    ...
    const navGroups = [
        ...
        },
        {
            ...
            items: [
                { href: '/expenses', label: 'Caja y Gastos', icon: Wallet },
            ]
        },
        {
            title: "Marketing",
